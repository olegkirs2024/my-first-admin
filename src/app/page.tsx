  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-16">
      ...
      <div className="fixed top-4 right-4">
        <Link
          href="/admin"
          className="flex items-center gap-2 px-3 py-2 text-xs font-medium text-gray-400 border border-gray-200 bg-white rounded-lg hover:text-gray-700 hover:border-gray-300 transition"
        >
